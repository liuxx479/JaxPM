...
def pm_forces(positions, mesh_shape=None, delta_k=None, halo_size=0, sharding_info=None):
    ...
    gspmd_kx = multihost_utils.host_local_array_to_global_array(local_kx ,sharding_info.mesh, P('z'))
    gspmd_ky = multihost_utils.host_local_array_to_global_array(local_ky ,sharding_info.mesh, P('y'))
    ...
    for i in range(3):
        ...
        force = cic_read(ifft_forces, positions, halo_size=halo_size, sharding_info=sharding_info)
        forces.append(force)
...
def linear_field(cosmo, mesh_shape, box_size, key, sharding_info=None):
    ...
    field = multihost_utils.host_local_array_to_global_array(
      slice_field, sharding_info.mesh, P('z', 'y'))
